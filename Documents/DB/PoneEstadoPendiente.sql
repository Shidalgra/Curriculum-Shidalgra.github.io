------------------------------------------------------------------------------------------------------------------------------------------
use rnpconta
-- para ver el estado de la CompFEProcId poner el Consecutivo interno al final reemplazando el que esta
select * from CompFEProc where CompFEProcId = 371050
select * from CompFEProc where CompFEProcId = 371051

--Comparamos el XMLFirmado y el XMLSinFirmar


--Aca declaramos el consetivo mas alto y le sumamos 1,
declare  @maximo int
...
--Insertamos ese consecutivo intercambiando el estado que se encuentra con error "5" a pendiente "1"
insert into @table
...
--de aqui para atras corramolo primero luego le hacemos el update cuando estemos seguros

-------------------------------------------------------------------------------------------------------------------------------------------


--una vez cambiado el estado le hacemos el update para cambiarle ahora si el consecutivo 
update  C
set C.CompFEProcConsecutivoNum = T.ConsecNuevo,
C.CompFEProcRespuestaTrib = '',
C.CompFEProcEstado = 1, 
C.CompFEProcXmlSinFirmar = '', 
